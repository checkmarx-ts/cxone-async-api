...
async def retrieve_aggregated_summary_of_sast_results(
    client: CxOneClient, **kwargs
) -> requests.Response:
    """|LowLevelApiDocstring| Verb: GET Endpoint: /api/sast-scan-summary/aggregate"""
...
@dashargs("query-ids", "base-scan-id", "group-by-field", "scan-id")
async def retrieve_aggregated_summary_of_sast_results_comparison(
    client: CxOneClient, **kwargs
) -> requests.Response:
    """|LowLevelApiDocstring| Verb: GET Endpoint: /api/sast-scan-summary/compare/aggregate"""

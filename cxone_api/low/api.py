...
async def retrieve_apisec_security_risks(
    client: CxOneClient, scan_id: str, **kwargs
) -> requests.Response:
    """|LowLevelApiDocstring| Verb: GET Endpoint: /api/apisec/static/api/risks/{scan_id}"""
...
async def retrieve_risk_details(client: CxOneClient, risk_id: str) -> requests.Response:
    """|LowLevelApiDocstring| Verb: GET Endpoint: /api/apisec/static/api/risks/risk/{risk_id}"""

...
async def run_a_scan(client: CxOneClient, payload: dict) -> requests.Response:
    """|LowLevelApiDocstring| Endpoint: /api/scans"""
...
async def retrieve_scan_details(client: CxOneClient, scanid: str) -> requests.Response:
    """|LowLevelApiDocstring| Endpoint: /api/scans/{scanid}"""
...
async def retrieve_scan_workflow(client: CxOneClient, scanid: str, **kwargs):
    """|LowLevelApiDocstring| Endpoint: /api/scans/{scanid}/workflow"""
...
async def update_scan_tags(
    ...
    """|LowLevelApiDocstring| Endpoint: /api/scans/{scan_id}/tags"""
...
async def retrieve_values_for_fields(
    ...
    """|LowLevelApiDocstring| Endpoint: /api/scans/fieldValues"""
...
async def run_a_repo_scan(
    ...
    """|LowLevelApiDocstring| Endpoint: /api/repos-manager/scms/{scmid}/orgs/{repo_org}/repo/projectScan?projectId={projectId}"""
    url = urljoin(
        client.api_endpoint,
